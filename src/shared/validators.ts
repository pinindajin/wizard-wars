...
export const serverPerformanceStatusPayloadSchema = z.object({
  ...
  metrics: z.object({
    ...
    roomTickDurationMs: z.number().finite().nonnegative().optional(),
    ...
    visualBudgetDroppedVisuals: z.number().int().nonnegative().optional(),
    criticalSendFailures: z.number().int().nonnegative().optional(),
    processEventLoopDelayMs: z.number().finite().nonnegative().optional(),
