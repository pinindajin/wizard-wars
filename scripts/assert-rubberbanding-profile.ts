...
const THRESHOLDS_BY_SCENARIO: ReadonlyMap<string, readonly MetricThreshold[]> = new Map([
  ...
  [
    ...
    [
      ...
      { metric: "maxActiveHeartbeatGapMs", absoluteMax: 100 },
      { metric: "maxIdleHeartbeatGapMs", absoluteMax: 1_000 },
      { metric: "transitionAckLatencyMs", absoluteMax: 100 },
      { metric: "lostAbilityEdges", absoluteMax: 0 },
      { metric: "duplicateAbilityEdges", absoluteMax: 0 },
      { metric: "missedWeaponReleaseCount", absoluteMax: 0 },
      { metric: "legacyClientFailureCount", absoluteMax: 0 },
